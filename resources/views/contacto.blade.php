...
@section('contenido')
    ...
    <script>
        ...
        function initMap() {
  //   @39.4954335,-0.4196129,21z
          var uluru = {lat: 39.4955432, lng: -0.41972931875};
          ...
          var marker = new google.maps.Marker({position: uluru, map: map});
            ...
            <script async defer
            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDLq7o6Ec6IOPraQls3bgh7ZcWUeF-W7iw&callback=initMap">
            </script>
            ...
            <form id="contactForm" action="javascript:void(0);" method="get"><input class="form-control" type="hidden" name="Introduction" value="This email was sent from www.awebsite.com"><input class="form-control" type="hidden" name="subject" value="Awebsite.com Contact Form"><input class="form-control" type="hidden"
                ...
                <div class="form-row">
                    <div class="col-12 col-md-6" id="message">
                        <h2 class="h4"><i class="fa fa-envelope"></i> Contactanos!<small><small class="required-input">&nbsp;(*required)</small></small>
                        </h2>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-12 col-sm-6 col-md-12 col-lg-6">
                                <div class="form-group"><label for="from-calltime">Mejor Tiempo Para Llamar</label>
                                    <div class="input-group">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-sm-6 col-md-12 col-lg-6">
                                ...
                                <div><span><strong>Correo y Página Web</strong></span></div>
